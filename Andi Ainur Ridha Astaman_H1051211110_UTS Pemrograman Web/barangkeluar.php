...
<html lang="en">
    <head>
        ...
        <title>Barang Keluar - Toko Dhaqilqin</title>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Tambah Barang Keluar</h1>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="text" name="pembeli" placeholder="Pembeli" class="form-control" required><br>
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary" name="kurangbarangkeluar">Simpan</button>
                                        </div>
                                        </form>
                                        <!--Aliran kontrol dan fungsi untuk menambah form yang telah diisi ke tabel dan update isi barang-->
                                        <?php
                                            if(isset($_POST['kurangbarangkeluar'])){
                                                ...
                                                $penguranganbarangsekarangdankeluar = $jumlahsekarang-$qty;

                                                $isitabelkeluar = mysqli_query($connect, "INSERT INTO barang_keluar (id_barang, qty, penerima) VALUES ('$barangterdaftar','$qty','$pembeli')");
                                                $updatejumlahkeluar = mysqli_query($connect, "UPDATE barang SET jumlah='$penguranganbarangsekarangdankeluar' WHERE id_barang='$barangterdaftar'");

                                                if ($isitabelkeluar && $updatejumlahkeluar){
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $databarang = mysqli_query($connect, "SELECT * FROM barang_keluar m, barang s WHERE s.id_barang = m.id_barang");
